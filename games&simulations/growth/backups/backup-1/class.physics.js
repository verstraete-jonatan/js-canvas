...
class PhyisicsClass {
  constructor() {
    ...
    this.angle = degRad(180);
    this.rotationSpeed = 0.35; // radians
    this.radius = 0.3;
  ...
  getRotation() {
    return [
      Math.cos(this.angle * this.rotationSpeed) * this.radius,
      Math.sin(this.angle * this.rotationSpeed) * this.radius,
    ];
  }

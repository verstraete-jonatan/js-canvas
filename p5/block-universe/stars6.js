...
function init() {
  class Dust {
    ...
    draw(next) {
      ...
      const color =
        "#" +
        Math.round(4110 * (r / 5 + 0.5)).toString(16) +
        Math.round(Math.abs(r * 20)).toString(16);

      // const greyish = "#" + Math.round(16777215 * (r + 0.5)).toString(16);
...
function draw() {
  ...
  if (!pause) {
    ...
    blocks.forEach((i, idx, arr) => {
      ...
      // const h = Math.round((v / 255) * 273)

      // const h =
      //   "#" +
      //   Math.round((16777215 / 255) * v)
      //     .toString(16)
      //     .padStart(5, "0")
      //     .slice(0, 3);

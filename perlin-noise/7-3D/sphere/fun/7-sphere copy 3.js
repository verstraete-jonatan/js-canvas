...
class Point {
  constructor(id) {
    this.id = id;
    this.alpha = 1;
    this.theta = id / 10; //PI + cos(id / 100) * 100; //+cos(id/20)//randfloat(0, PI2, 5)
    this.phi = id / 1000; //PI + tan(id * 100) * 100; //+tan(id*100)//randfloat(0, PI, 5)
    this.projScale = 0;
    this.projX = 0;
    this.projY = 0;
    this.x = 0;
...
class Sphere {
  constructor() {
    ...
    // this.points = this.points.sortDc("z");
